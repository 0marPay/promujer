...
file = "malos_registros.csv"
print("Registros")
file = folder_path + '/' + file
data = pd.read_csv(file, encoding='latin-1')
data = data[["Correo","Programa_id"]]
print(data.head(5)); print()

print("usuarios (db)")
usuarios = get_data_from_sql(connection, table_name="usuario")
usuarios = usuarios[["mail", "id"]]
print(usuarios.head(5)); print()

print("combinacion")
nuevo_df = usuarios.merge(data, left_on='mail', right_on='Correo', how='left')
nuevo_df = nuevo_df[["id", "Correo", "Programa_id"]]
nuevo_df = nuevo_df.dropna(subset=['Correo'])
nuevo_df['Programa_id'] = nuevo_df['Programa_id'].astype(int)
print(nuevo_df.head(5)); print()
